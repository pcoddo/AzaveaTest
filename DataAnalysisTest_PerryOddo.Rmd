...
> *Because the CEO's salary is a continuous variable, we would likely use a regression model. In this case, we are trying to infer the relationship between industry, number of employees, and total profit, and the CEO salary. For this scenario*
...
# Re-combine ontinuous training set with 'binary_median' variable 
